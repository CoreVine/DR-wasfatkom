                                ...
                                <div class="tab-content p-0">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mt-3">
                                                    <label class="form-label mb-1"
                                                        for="name_{{ $lang->code }}">{{ __('messages_303.name') }}
                                                        ({{ $lang->code }})
                                                    </label>
                                                    <input type="text" id="name_{{ $lang->code }}"
                                                        ...
                                                        value="{{ old('name_' . $lang->code, $item->name) }}" />
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="  col-md-6 mt-4">
                                            ...
                                            <input type="date" value="{{ old('expire_date', $item->expire_date) }}"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="formFile"
                                                class="form-label">{{ __('messages_303.barcode') }}</label>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            is-invalid
                                          @enderror"
                                                type="number" name="qty" value="{{ old('qty', $item->qty) }}">
                                            @error('qty')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control @error('price') is-invalid @enderror"
                                                type="number" id="formFile" name="price"
