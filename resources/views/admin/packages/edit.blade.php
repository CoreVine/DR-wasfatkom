                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <textarea id="description_{{ $lang->code }}"
                                                        ...
                                                        name="description_{{ $lang->code }}">{{ old('description_' . $lang->code, $item->description) }}</textarea> <!-- Fetch existing package description -->
                                    ...
                                    @enderror"
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}"
                                                {{ in_array($product->id, old('products', $item->products->pluck('id')->toArray())) ? 'selected' : '' }}>
                                                {{ $product->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('products')
