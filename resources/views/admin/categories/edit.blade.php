                    ...
                    <form class="card-body" action="{{ route('admin.categories.update', $item->id) }}" method="POST"
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="{{ asset($item->image) }}" alt="user-avatar"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label class="switch switch-primary ">
                                                <input type="checkbox" name="is_commission" @checked(old('is_commission') == 'on' || $item->is_commission == 1)
                                                    id="is_doctor" class="switch-input">
