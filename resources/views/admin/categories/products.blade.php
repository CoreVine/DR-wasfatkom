...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  __('messages.Categories') => route('admin.categories.index'),
  $category->id => route('admin.categories.edit', $category->id),
  __('messages.Products') => 'active',
  ],
  ])
              ...
              <div class="row ">
                <div class="col-md-10">
                  ...
                  <select id="columnSelect" class="form-select" multiple>
                    ...
                    <option value="expire_date" selected>{{ __('messages_301.Expire date') }}</option>
                ...
                <table class="table" id="dynamicTable">
                  <thead>
                    <tr>
                      ...
                      <th class="dynamic-column" data-column="expire_date">{{ __('messages_301.Expire date') }}</th>
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                      ...
                      <td class="dynamic-column" data-column="expire_date">{{ $item->expire_date }}</td>
