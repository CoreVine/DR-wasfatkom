    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        @include('inc.breadcrumb', [
            'breadcrumb_items' => [
                ...
                __('messages_303.categories') => 'active',
            ],
        ])
            ...
            <div class="p-3 d-flex justify-content-between">
                ...
                <div>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        {{-- <a href="{{ route('admin.categories.export') }}" class="btn btn-outline-primary waves-effect text-primary">{{ __("messages.EXPORT XLS") }}<i class="fa-solid fa-file-export"></i></a> --}}
                        @can('create_category')
