...
<div class="container-xxl flex-grow-1 container-p-y">
	...
	__('messages_303.formulations') => route('admin.formulations.index'),
	...
	<div class="row justify-content-center">
		<div class="col-md-12">
			<div class="card mb-4">
				<h5 class="card-header">{{ __('messages_303.formulations') }}</h5>
				<form class="card-body" action="{{ route('admin.formulations.as-upadte', $item->id) }}" method="POST"
						...
						<div class="nav-align-top  mb-4">
							...
							<div class="tab-content p-0">
								...
								<div class="row g-3">
									...
									<div class="col-md-6 mb-3">
										<label for="formFile" class="form-label">{{ __('messages_303.barcode') }}</label>
										<input value="{{ old('barcode', $item->barcode) }}" class="form-control @error('barcode')
                                            is-invalid
                                          @enderror" type="text" name="barcode">
										@error('barcode')
										<small class="text-danger">{{ $message }}</small>
										@enderror
									</div>
