        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <form class="card-body" action="{{ route('admin.sub_categories.update', $item->id) }}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mt-3">
                                                    ...
                                                    <input type="text" id="name_{{ $lang->code }}"
                                                        ...
                                                        value="{{ old('name_' . $lang->code, \App\Http\Helpers\HelperTranslate::get_value($item, $lang->code, 'name')) }}" />
