        ...
        <div class="col-xl-12 col-md-12 col-12 mb-md-0 mb-4">
            <div class="card invoice-preview-card">
                    ...
                    <div class="row m-sm-4 m-0">
                                ...
                                <div class="d-flex flex-column justify-content-end gap-2 gap-sm-0">
                                    ...
                                    <h5 class="mb-1 mt-3 d-flex flex-wrap gap-2 align-items-end">
                                        ...
                                        {{ __('messages.Status') }} <span
                                            class="badge bg-label-{{ App\Http\Helpers\HelperApp::get_color_status($item->status) }} me-1">{{ __('messages.' . $item->status) }}</span>
                                    </h5>
                                    @endcan
                                </div>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <input disabled value="#{{ $item->invoice_num }}" type="text"
                                        class="form-control">
                                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-center">
                                <img width="100" height="100" src="{{ asset('uploads/invoice-qr').'/' . $item->id . '.png' }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-4">
                        ...
                        <div class="mb-1">
                         ...
                         <div class="coupon_discount">
                            {{ __('messages.Total before tax') }} : <span
                                class="h5">{{ $item->total -  $item->tax_value }}</span>
                        </div>
                        <div class="coupon_discount">
                            {{ __('messages.Total') }} : <span
                                class="h5">{{ $item->total }}</span>
                        </div>
                        ...
                        @if ($item->reviewer && $item->status == \App\Enums\OrderStatusEnum::Draft->value)
                            <div class="d-flex justify-content-end mb-3">
                                <button type="button" data-url="{{ route('admin.invoices.review', $item->id) }}"
                                    ...
                                    class="btn btn-primary me-sm-3 me-1 waves-effect waves-light btn-action">{{ __('messages.Reviewed and obtained client copy') }}</button>
                            </div>
                        @endif
                    @endcan
                                ...
                                <form  action="{{ route('admin.invoices.send_invoice' , $item->id) }}" method="POST">
                                    <div class="d-flex">
                                        <input readonly name="link_payment" id="input_link" type="text" class="form-control"
                                            ...
                                            <input name="coupon" placeholder="Coupone Code" id="input_link" type="text" class="form-control mx-2"
                                            value="">
                ...
                @else
                    ...
                    @else
                    <div class="row g-3">
                        <form class="card-body" id="coupon_check" action="{{ route('payment.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="col-md-2 pt-4">
                                    <button
                                        class="btn btn-primary me-sm-3 me-1 btn-check-coupon {{ $item->coupon ? 'd-none' : '' }}">{{ __('messages_301.Check') }}</button>
                                </div>
                                ...
                                <div class="col-md mb-md-0 mb-2">
                                  <div class="form-check custom-option custom-option-basic">
                                    <label class="form-check-label custom-option-content" for="customRadioAddress1">
                                      <input name="payment_type" class="form-check-input" required type="radio" value="my_fatoora" id="customRadioAddress1">
                                      <span class="custom-option-header mb-2">
                                        <span class="fw-medium text-heading mb-0 px-3 py-1 rounded" style="background: #fff">
                                ...
                                <div class="col-md">
                                  <div class="form-check custom-option custom-option-basic checked">
                                    <label class="form-check-label custom-option-content" for="customRadioAddress2">
                                      <input name="payment_type" class="form-check-input" required type="radio" value="tamara" id="customRadioAddress2">
                                      <span class="custom-option-header mb-2">
                                        <span  class="fw-medium text-heading mb-0 rounded px-3 py-1" style="background: #fff;width: 186px">
