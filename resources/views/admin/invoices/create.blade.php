              ...
              <div class="card-body">
                <div class="row m-sm-4 m-0 ">
                  ...
                  <div class="col-md-5 mt-4">
                    <div class="row">
                      <div class="col-12">
                        <input disabled type="text" class="form-control" placeholder="YYYY-MM-DD" value="{{ date('Y-m-d') }}"/>
                      </div>
                      {{-- <div class="col-6">
                    ...
                    <div class="col-12 col-md-6 mt-2">
                      ...
                      <select name="review_id" class=" form-select  form-control select2" data-allow-clear="true">
                        ...
                        @foreach ($reviewers as $reviewer)
                          <option @selected ($reviewers->count() == 1 ) value="{{ $reviewer->id }}" @selected(old('review_id') == $reviewer->id)>
                            {{ $reviewer->name }}
                          </option>
                        @endforeach
                      </select>
                ...
                <div class="source-item px-0">
                      ...
                      <div class="d-flex border rounded position-relative pe-0">
                        <div class="row w-100 p-3">
                          ...
                          <div class="col-md-4 col-12">
                            ...
                            <input readonly value="" type="text" class="form-control invoice-item-price mb-3 price" name="price" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Qty') }}</label>
                            <input name="qty" value="1" type="text" class="form-control invoice-item-price mb-3 qty" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12" @if (auth()->user()->type->value != 'admin') style="display: none" @endif>
                            <label class="my-2">{{ __('messages.Discount percentage') }} %</label>
                            <input value="0" name="discount" type="text" class="form-control invoice-item-price mb-3 discount" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Total') }}</label>
                            <input value="0" name="total_befor_discount" type="hidden" class="form-control invoice-item-price mb-3 total_befor_discount" placeholder=""/>
                            <input readonly value="0" name="total" type="text" class="form-control invoice-item-price mb-3 total" placeholder=""/>
                          </div>
                        ...
                        <div class="d-flex flex-column align-items-center justify-content-between border-start p-2">
                          ...
                          <i class="fa-regular fa-heart cursor-pointer  btn_add_or_remove_item_from_favorite  icon_favorite" data-product_id=""></i>
                          <div class="dropdown">
                  ...
                  <div class="row pb-4">
                    <div class="col-12">
                      <button
                        type="button" class="btn btn-primary add_another_product" data-repeater-create>
                ...
                <div class="source-item px-0">
                  ...
                  <div class="row pb-4">
                    <div class="col-12">
                      <button type="button" class="btn btn-primary add-new-package" data-repeater-create>
                ...
                <div class="source-item px-0">
                      ...
                      <div class="d-flex border rounded position-relative pe-0">
                        <div class="row w-100 p-3">
                          ...
                          <div class="col-md-8 col-12">
                            ...
                            <select name="formulation_id" class="select2 form-select formulation_select" data-allow-clear="true">
                              <option value="">----</option>
                          ...
                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Price') }}</label>
                            <input readonly value="" type="text" class="form-control invoice-formulation-price mb-3 price" name="price" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Discount') }}</label>
                            <input value="0" type="text" class="form-control invoice-formulation-price mb-3 discount" name="discount" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Qty') }}</label>
                            <input name="qty" value="1" type="text" class="form-control invoice-formulation-price mb-3 qty" placeholder=""/>
                          </div>

                          <div class="col-md-4 col-12">
                            <label class="my-2">{{ __('messages.Total') }}</label>
                            <input value="0" name="total" type="number" class="form-control invoice-formulation-price mb-3 total" placeholder="" readonly />
                          </div>
                  ...
                  <div class="row pb-4">
                    <div class="col-12">
                      <button type="button" class="btn btn-primary add-new-formulation" data-repeater-create>
                ...
                <div class="row">
                  <div class="col-md-4 col-12 mt-2"
                    ...
                    <input name="doctor_commission" value="{{ App\Http\Helpers\HelperSetting::get_value('general_account_doctors_commission') }}" type="number" class="form-control doctors_commission" value="">
                  </div>
                  ...
                  <div class="col-12 col-md-4 mt-2">
                    ...
                    <input name="discount" readonly class="form-control invoice_discount" value="">
                  </div>
                  <div class="col-12 col-md-4  mt-2">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="mb-3">
                      ...
                      <textarea name="notes" class="form-control" rows="2" id="note" placeholder="{{ __('messages.Invoice note') }}"></textarea>
                    </div>
                  </div>
                </div>
