                        ...
                        <div class="card invoice-preview-card">
                            <div class="card-body">
                                ...
                                <div class="source-item pt-4 px-0 px-sm-4">
                                    <div class="mb-3 mt-3" data-repeater-list="items">
                                            ...
                                            <div class="d-flex border rounded position-relative pe-0">
                                                <div class="row w-100 p-3">
                                                    <div class="col-md-8 col-12" >
                                                        ...
                                                        <select name="product_id" class="select2 form-select product_select"
                                                            data-allow-clear="true">
                                                            <option value="" data-category="">----</option>
                                                            @foreach ($products as $product)
                                                                <option data-category="{{ $product->sub_category?->name }}  {{ $product->name }} {{ $product->category->name }}  {{ $product->barcode }}"
