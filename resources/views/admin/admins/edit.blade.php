        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-4">
                    ...
                    <form class="card-body" action="{{ route('admin.admins.update', $item->id) }}" method="POST"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="email" value="{{ old('email', $item->email) }}"
                                    id="multicol-email" class="form-control  @error('email') is-invalid @enderror" />
                                @error('email')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <hr class="my-4 mx-n4" />
                        <h6>1. {{ __('messages.Identify doctors') }}</h6>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <label class="switch switch-primary ">
                                    <input type="checkbox" name="is_all_doctor" @checked(old('is_doctor')=='on' || $item->is_all_doctor == '1') id="is_doctor"
                                        class="switch-input">
                                                        ...
                                                        <div class="col-md-2 col-6  mb-2">
                                                            <div class="form-check custom-option custom-option-basic">
                                                                <label class="form-check-label custom-option-content"
                                                                    ...
                                                                    <input @checked(in_array($sub_key, old('permissions', $permissions_admin)))
                                                                        name="permissions[]" class="form-check-input"
                                                                        type="checkbox" value="{{ $sub_key }}"
                                                                        id="{{ $sub_key }}">
