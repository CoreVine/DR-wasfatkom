                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" value="{{ old('name', $item->name) }}"
                                    id="multicol-email" class="form-control  @error('name') is-invalid @enderror" />
                                @error('name')
                            ...
                            <div class="col-md-6">
                                <label class="form-label"
                                    for="multicol-username">{{ __('messages_301.Clinic name') }}</label>
                                <input type="text" id="multicol-username"
                                    class="form-control  @error('clinic_name') is-invalid @enderror" name="clinic_name"
                                    value="{{ old('clinic_name', $item->clinic_name) }}" />
                                @error('clinic_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
