            ...
            <div class="p-3 d-flex justify-content-between">
                ...
                <div>
                    <div class="btn-group" role="group" aria-label="Basic example">
                        {{-- <a href="{{ route('admin.doctors.export') }}" class="btn btn-outline-primary waves-effect text-primary">{{ __("messages.EXPORT XLS") }}<i class="fa-solid fa-file-export"></i></a> --}}
                        @can('create_doctor')
                        <a href="{{ route('admin.doctors.export_sales'  ,$doctor->id) }}" class="btn btn-outline-primary waves-effect text-primary"><span class="d-none d-sm-block">{{ __("messages.EXPORT XLS") }}</span><i class="fa-solid fa-file-export"></i></a>
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->total }}</td>
                                <td>{{ $item->invoice->created_at_format }}</td>
