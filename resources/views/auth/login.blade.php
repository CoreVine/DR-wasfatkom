...
<body>
  ...
  <div class="authentication-wrapper authentication-cover authentication-bg">
    <div class="authentication-inner row">
      ...
      <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
          ...
          <p class="mb-4">Welcome to the {{ config('app.name') }} application control panel</p>
    ...
    input-group-merge">
          ...
          <a class="mt-4 text-center block mx-auto w-fit" href="/register">Create new account?</a>
          <span>
            Made With Wasftkom
          </span>
